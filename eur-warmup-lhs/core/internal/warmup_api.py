...
def run_step1(
    ...
    def _run_step1_internal():
        ...
        adequacy, budget = sampler.evaluate_budget(
            ...
            main_effects_first=config.main_effects_first,
            n_core1=config.n_core1,
        )
        ...
        if not config.auto_confirm:
            if adequacy in [ADEQUACY_INSUFFICIENT, ADEQUACY_SEVERE]:
                logger.warning(f"Budget adequacy is [{adequacy}], proceeding is not recommended")
        ...
        exported_files = sampler.generate_samples(
            ...
            repeat_one_point=config.repeat_one_point,
            core2a_method=config.core2a_method,
        )
...
def run_step3(
    ...
    def _run_step3_internal():
        ...
        result = process_step3(
            ...
            y_normalization_type=config.y_normalization_type,
            noise_lower_bound=config.noise_lower_bound,
        )
