...
class Step1Config:
    ...
    n_core1: int = 4 # 共享锚点数量 (每个被试都会测的点)
    core2a_method: str = "d-optimal" # "d-optimal", "stratified" (均匀覆盖) 或 "oa" (正交/均衡)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "main_effects_first": self.main_effects_first,
            "repeat_one_point": self.repeat_one_point,
            "core2a_method": self.core2a_method,
        }
...
class Step3Config:
    ...
    Attributes:
        ...
        output_dir: 输出目录
        y_normalization_type: y标准化类型 (zscore/mean_centering)
        noise_lower_bound: 噪声下界 (likelihood noise constraint)
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "output_dir": self.output_dir,
            "y_normalization_type": self.y_normalization_type,
